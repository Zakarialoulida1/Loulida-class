...
<body>
    ...
    <body>
        ...
        <section class="flex m-4 items-center flex-wrap justify-between">

            <div class="xl:w-[28vw]  lg:w-[40vw] m-8 rounded-lg  shadow-2xl  bg-gray-100">

                <div class="p-4 relative">
                    <img class="rounded-md w-full   " src="{{ asset('images/physic.jpg') }}" alt="Your Image">
                    <div class=" absolute rounded bg-gray-200 right-6 top-6">
                        <div class="p-1">
                            <div class="flex   ">
                                <img class="w-6 shadow-2xl " src="{{ asset('images/clock_2784459.png') }}"
                                    alt="">
                                <h6> 01 hr 20 min</h6>
                            </div>
                        </div>
                ...
                <div class="h-full pb-4">
                    <div class="mx-4 flex justify-between">
                        <h1 class="font-bold">2 BAC Physique</h1>
                    ...
                    <p class="mt-3 mx-4 text-base text-gray-500">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora dolores maiores veritatis
                        maxime
                        optio? Facilis est fugit praesentium rerum saepe, esse, officia repellendus alias ipsum optio
                        eveniet quo vel temporibus.
                    </p>
                    <div class="flex ml-3">
                        ...
                        <span class="ml-4 p-md2 text-gray-500">(200 Etudiant) </span>
                    </div>
                    ...
                    <div class="flex items-center divide-x-2  divide-blue-400 justify-between m-4">
                        ...
                        <h1 class=" text-2xl p-2 text-green-500"> 200 DH</h1>
                ...
                <div class="h-full pb-4">
                    ...
                    <div class="flex items-center divide-x-2  divide-blue-400 justify-between m-4">
                        <div class="w-fit flex">
                            ...
                            <div class="ml-2">
                                <h1>LOULIDA ZAKARIA</h1>
                                <p class="mt-1   text-base text-gray-500">experience plusde 5 ans </p>
                            </div>
                        </div>
                        <h1 class=" text-2xl p-2 text-green-500"> 200 DH</h1>
        ...
        <section class="flex m-4 items-center flex-wrap justify-between">
            ...
            <div
                ...
                <img class="w-16 rounded-full " src="{{ asset('images/service.jpg') }}" alt="prof">
