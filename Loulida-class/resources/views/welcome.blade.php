...
@section('content')
    ...
    <div class="mx-auto w-[10vw]">
            ...
            <button id="seeMoreButton" class="px-4 py-2 mt-12 w-fit mx-auto bg-[#ffb703] hover:bg-[#fb8500] text-white rounded">See More</button>
    ...
    seeMoreButton.addEventListener('click', loadMoreData());
