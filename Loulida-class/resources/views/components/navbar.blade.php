...
<nav class="bg-gray-200 shadow mb-16 shadow-gray-300 w-100  md:px-auto">
                ...
                <ul
                    ...
                    <li class="block px-4 py-2 text-black hover:bg-[#ffb703] hover:text-white">
                        <div class="flex">
                            ...
                            </svg><a href="{{ route('profile') }}">Profile</a>
                        </div>
                    </li>
                    <li class="block px-4 py-2 text-black hover:bg-[#ffb703] hover:text-white">
    ...
    <div id="menu-items"
        ...
        <ul class="flex flex-col w-full bg-gray-200 lg:flex-row font-semibold justify-between">
            ...
            <li class="px-4 py-2 hover:text-[#ffb703]"><a href="{{ route('cours.display') }}">Explore</a></li>
            <li class="px-4 py-2 hover:text-[#ffb703]"><a href="{{ route('formations.create') }}">Create
                    Formation </a></li>
            <li class="px-4 py-2 hover:text-[#ffb703]"><a href="{{ route('Abbonement') }}">Mes Abbonnement
                </a></li>
            @auth
                ...
                <li class="px-4 py-2 hover:text-[#ffb703]"><a href="{{ route('matieres') }}">ADD a Subject </a>
                </li>
