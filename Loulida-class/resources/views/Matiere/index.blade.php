...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <form role="form text-left"
                                            action="{{ route('delete.matiere', ['id' => $item['id']]) }} " method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button
                                    ...
                                    <td>
                                        ...
                                        <!-- Modal toggle -->
                                        <button onclick="editmatiere('{{ $item->id }}','{{ $item->name }}')"
                                            class="w-5   text-green-500 " type="button">
            ...
            <div class="bg-white dark:bg-slate-850 rounded-lg shadow-xl p-6">
                ...
                <div class="text-center">
                    ...
                    <form id="update-matiere-form" action="{{ route('update.matiere') }}" method="post">
                        ...
                        @method('PUT')
                        <div class="mb-4">
                            <input id="matiere-name" type="text" name="name"
                    ...
                    <form action="{{ route('addmatiere') }}" method="post">
                        ...
                        <div class="text-center">
                            <button type="submit" name="submit"
                                ...
                                Subject</button>
                            <button type="button" onclick="toggleModal('add-matiere-modal')"
                                class="inline-block ml-4 px-6 py-3 font-bold text-center text-white uppercase align-middle transition-all bg-gray-400 hover:bg-gray-500 rounded-lg cursor-pointer">CANCEL</button>
    ...
    <!-- Add matiere Button -->
    <button onclick="toggleModal('add-matiere-modal')"
