         ...
         @foreach ($cycles as $cycle)
                    ...
                    @foreach ($cycle->matieres as $matiere)
                        <div class="ml-8">
                            ...
                            <div class="matiere-cours" style="display: none;">
                                                    ...
                                                    <tr class="divide-x-2">
                                                        ...
                                                        <td
                                                            ...
                                                            @if ($course->coursFiles->isNotEmpty())
                                                                <ul class="underline text-red-500 text flex flex-col md:flex-row  ">
                                                            ...
                                                            @if (partner()->matiere_id === $matiere->id)
                                                                        ...
                                                                        <li>
                                                                            <div class="flex m-2 ">
                                                                                ...
                                                                                @foreach ($file->correctionFiles as $correctionFile)
                                                                                    ...
                                                                                    <a href="{{ asset('storage/' . substr($correctionFile->path, 7)) }}"
                                                                                        target="_blank"> <img
                                                                                            class="w-10 inline-block align-middle"
                                                                                            src="{{ asset('images/pdf.png') }}"
                                                                                            alt="PDF"></a>
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="bg-gray-200 rounded-lg  max-w-md w-full">
                                                                        <h1 class="text-center text-bold text-2xl">Update
                                                                            Your
                                                                            cours</h1>
                                                                        <form
                                                                            action="{{ route('courses.update', $course->id) }}"
                                                                            method="post"
                                                                            class="flex mt-4 mr-4 flex-col">
                                                                            @csrf
                                                                            @method('put')
                                                                            ...
                                                                            <div class=" ml-4 input__wrapper">
                                                                                ...
                                                                                <input type="text" name="title"
                                                                                    multiple class="  w-full input__field"
                                                                                    value="{{ $course->title }}">
                                                                            </div>
                                ...
                                @else
                                    <h1 class="text-center text-red-400 text-capitalize  text-black"> Aucun Cours Créer
                                        jusqu'a
                                        maintenant</h1>
                                @endif
                            </div>
            ...
            <div
                ...
                <div class="relative bg-gray-200 rounded-lg p-8 max-w-md w-full">
                    <div class=" flex justify-around"> <button id="exercise-files-with-correction-btn"
                    ...
                    <div class="hidden exercise-file-form-with-correction ">
                        <div class="bg-gray-200 rounded-lg p-8 max-w-md w-full">
                            <form action="{{ route('exercise-files-with-correction.store') }}" method="post"
                                enctype="multipart/form-data">
                                @csrf
                                <input class="course_id" type="hidden" name="course_id" value="">

                                <div class="input__wrapper">
                                    <label for="exercise_files_with_correction" class="input__label">Exercise Files
                                        (with correction)
                                        :</label>
                                    <input type="file" id="exercise_files_with_correction"
                                        name="exercise_files_with_correction[]" multiple class="input__field">
                                </div>
                                <!-- Add input for correction files if needed -->
                                <div class="input__wrapper">
                                    <label for="correction_files" class="input__label">Correction
                                        Files:</label>
                                    <input type="file" id="correction_files" name="correction_files[]" multiple
                                        class="input__field">
                                </div>
                                <button type="submit" class="bg-blue-500 text-white m-4 px-4 py-2 rounded">Add
                                    File</button>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="hidden exercise-file-form-without-correction ">
                        <div class="bg-gray-200 rounded-lg p-8 max-w-md w-full">
                            <form action="{{ route('exercise-files.store') }}" method="post"
                                ...
                                <div class="input__wrapper">
                                    <label for="exercise_files_without_correction" class="input__label">Exercise Files
                                        (without correction):</label>
                                    <input type="file" id="exercise_files_without_correction"
                                        name="exercise_files_without_correction[]" multiple class="input__field">
                                </div>
                                <button type="submit" class="bg-blue-500 text-white m-4 px-4 py-2 rounded">Add
                                    File</button>
                            </form>
            ...
            <script>
                ...
                document.querySelectorAll('.add-exercise-file-icon').forEach(icon => {
                    icon.addEventListener('click', function() {
                        ...
                        exerciseForms.querySelector('.exercise-file-form-with-correction input[name="course_id"]')
                            .value = courseId;
                        exerciseForms.querySelector(
                            '.exercise-file-form-without-correction input[name="course_id"]').value = courseId;
